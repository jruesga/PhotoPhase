...
a.logo?$("#appinfo").css("display","block"):$("#appinfo").css("display","none");a.track?($("#photo-details").css("display","block"),$("#album-details").css("display","block")):($("#photo-details").css("display","none"),$("#album-details").css("display","none"))};var pp_splash_transtion_registered=!1;
...
b.hasOwnProperty("cc")&&($.app_Configuration.cropCenter=b.cc),b.hasOwnProperty("bb")&&($.app_Configuration.blurredBackground=b.bb),$().app_onConfigurationChanged($.app_Configuration)):"cast"==c?(c=new $.app_Request,c.url=b.u,c.sender=b.s,c.token=b.k,c.title=b.t,c.album=b.a,c.width=b.w,c.height=b.h,$().app_onRequest(c)):"ping"==c?$().app_sendMessage(b.senderId,new $.app_Message("pong","{}")):"stop"==c&&$.app_Status.started&&$().app_onStop()};
