...
"url() no-repeat center"))})};var pp_backdrop_transtion_registered=!1;
$.fn.app_onStop=function(){if($.app_Status.started&&($.app_Status.started=!1,$("#backdrop, #media").removeClass().addClass("fadeout"),$.app_Status.currentTrackInfo=null,!pp_backdrop_transtion_registered))$("#backdrop, #media").on("transitionend webkitTransitionEnd",function(){$("#backdrop").hasClass("fadeout")&&($("#splash").removeClass().addClass("fadein"),$("#media-fg-blur").css("background","url() no-repeat center"),$("#media-fg-normal").css("background","url() no-repeat center"),$("#media-bg-blur").css("background",
"url() no-repeat center"),$("#media-bg-normal").css("background","url() no-repeat center"),$("#media-fg").removeClass().addClass("fadeout"),$("#media-bg").removeClass().addClass("fadeout"))})};$.fn.app_onRequest=function(a){$().app_onShowLoading(!0);$.app_Status.nextTrackInfo=a;setTimeout("$().app_onPerformRequest();",300)};
