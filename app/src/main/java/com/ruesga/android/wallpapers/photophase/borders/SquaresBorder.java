 ...
 * </table>
 */
public class SquaresBorder extends Border {
    ...
    private static final String FRAGMENT_SHADER =
            ...
            "  float bw = strength / w;\n" +
            "  float bh = strength / h;\n" +
            "  return (p.x < (0.0 + bw) && (p.y < (bh * 2.0) || p.y > (1.0 - bh * 2.0)))\n" +
            "      || (p.x > (1.0 - bw) && (p.y < (bh * 2.0) || p.y > (1.0 - bh * 2.0)))\n" +
            "      || (p.y < (0.0 + bh) && (p.x < (bw * 2.0) || p.x > (1.0 - bw * 2.0)))\n" +
            "      || (p.y > (1.0 - bh) && (p.x < (bw * 2.0) || p.x > (1.0 - bw * 2.0)));\n" +
            "}\n" +
            "void main(void)\n" +
            "{\n" +
