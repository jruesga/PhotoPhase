 ...
 * </table>
 */
public class InsetSquaresBorder extends Border {
    ...
    private static final String FRAGMENT_SHADER =
            ...
            "  return (p.x < (0.0 + spacerw + bw) && p.x > (0.0 + spacerw) && ((p.y > (0.0 + spacerh) && p.y < (0.0 + spacerh + bh * 2.0)) || (p.y < (1.0 - spacerh) && p.y > (1.0 - spacerh - bh * 2.0))))\n" +
            "      || (p.x > (1.0 - spacerw - bw) && p.x < (1.0 - spacerw) && ((p.y > (0.0 + spacerh) && p.y < (0.0 + spacerh + bh * 2.0)) || (p.y < (1.0 - spacerh) && p.y > (1.0 - spacerh - bh * 2.0))))\n" +
            "      || (p.y < (0.0 + spacerh + bh) && p.y > (0.0 + spacerh) && ((p.x > (0.0 + spacerw) && p.x < (0.0 + spacerw + bw * 2.0)) || (p.x < (1.0 - spacerw) && p.x > (1.0 - spacerw - bw * 2.0))))\n" +
            "      || (p.y > (1.0 - spacerh - bh) && p.y < (1.0 - spacerh) && ((p.x > (0.0 + spacerw) && p.x < (0.0 + spacerw + bw * 2.0)) || (p.x < (1.0 - spacerw) && p.x > (1.0 - spacerw - bw * 2.0))));\n" +
            "}\n" +
            "void main(void)\n" +
            "{\n" +
