...
/**
 * This double border around the texture.<br/>
 * <table>
...
public class DoubleBorder extends Border {
    ...
    public static final String STRENGTH_PARAMETER2 = "strength2";
    ...
    void applyParameters(int width, int height) {
        ...
        GLESUtil.glesCheckError("glUniform1f");
        GLES20.glUniform1f(mStrengthHandle2, mStrength2);
        GLESUtil.glesCheckError("glUniform1f");
    ...
    public void setParameter(String parameterKey, Object value) {
        ...
        } else if (parameterKey.compareTo(STRENGTH_PARAMETER2) == 0) {
            try {
                float strength2 = Float.parseFloat(value.toString());
                if (strength2 < 0) {
                    Log.w(TAG, "strength2 parameter must be > 0");
                    return;
                }
                mStrength2 = strength2;
            } catch (NumberFormatException ex) {
                // Ignore
            }
        }
